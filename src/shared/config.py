...
def load_config() -> AppConfig:
    ...
    return AppConfig(
        ...
        budget_model=os.getenv("BUDGET_MODEL", "moonshotai/kimi-k2.6:free"),
        analysis_model=os.getenv("ANALYSIS_MODEL", "mistralai/mistral-nemo"),
        reasoning_model=os.getenv("REASONING_MODEL", "google/gemini-2.5-flash"),
